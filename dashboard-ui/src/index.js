        ...
        <div className="tech-bg-card rounded-lg p-6 border border-blue-500/20">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              <div>
                ...
                <p className="mt-2 text-xs font-semibold uppercase tracking-[0.28em] text-blue-300/80">
                  SmartBridge Project Submission | Shreyash Dabhade
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between">
            <p className="text-muted-foreground">
              Real-time monitoring and AI-assisted analysis of distributed system health
            </p>
